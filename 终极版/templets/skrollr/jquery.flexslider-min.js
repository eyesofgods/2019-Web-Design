    ...
    e.flexslider = function (t, n) {
        ...
        v = {
            init: function () {
                ...
                if (r.vars.controlsContainer !== "") r.controlsContainer = e(r.vars.controlsContainer).length >
                    0 && e(r.vars.controlsContainer);
                if (r.vars.manualControls !== "") r.manualControls = e(r.vars.manualControls).length >
                    0 && e(r.vars.manualControls);
                if (r.vars.randomize) {
                ...
                if (r.vars.keyboard && (e(r.containerSelector).length === 1 || r.vars.multipleKeyboard)) {
                    e(document).bind("keyup", function (e) {
                        ...
                        if (!r.animating && (t === 39 || t === 37)) {
                            var n = t === 39 ? r.getTarget("next") : t === 37 ? r.getTarget(
                                "prev") : false;
                ...
                if (r.vars.slideshow) {
                    ...
                    if (!r.vars.pauseInvisible || !v.pauseInvisible.isHidden()) {
                        r.vars.initDelay > 0 ? r.startTimeout = setTimeout(r.play, r.vars.initDelay) :
                            r.play()
                    }
                }
                if (d) v.asNav.setup();
                    ...
                    if (!s) {
                        ...
                        r.slides.each(function () {
                            ...
                            t.addEventListener("MSPointerDown", function (e) {
                                e.preventDefault();
                                if (e.currentTarget._gesture) e.currentTarget._gesture.addPointer(
                                    e.pointerId)
                            }, false);
                            t.addEventListener("MSGestureTap", function (t) {
                                ...
                                if (!e(r.vars.asNavFor).data("flexslider").animating &&
                                    ...
                                    r.flexAnimate(i, r.vars.pauseOnAction, false, true,
                                        true)
                                }
                            })
                        })
                    ...
                    if (r.pagingCount > 1) {
                        for (var f = 0; f < r.pagingCount; f++) {
                            ...
                            if ("thumbnails" === r.vars.controlNav && true === r.vars.thumbCaptions) {
                                ...
                                if ("" != l && undefined != l) s += '<span class="' + i + 'caption">' +
                                    l + "</span>"
                            }
            ...
            directionNav: {
                ...
                update: function () {
                    ...
                    if (r.pagingCount === 1) {
                        ...
                        if (r.animatingTo === 0) {
                            r.directionNav.removeClass(e).filter("." + i + "prev").addClass(e).attr(
                                "tabindex", "-1")
                        } else if (r.animatingTo === r.last) {
                            r.directionNav.removeClass(e).filter("." + i + "next").addClass(e).attr(
                                "tabindex", "-1")
                        } else {
                ...
                if (!s) {
                        ...
                        if (!m || Number(new Date) - a > s) {
                            ...
                            if (!p && r.transitions) {
                                if (!r.vars.animationLoop) {
                                    u = u / (r.currentSlide === 0 && u < 0 || r.currentSlide === r.last &&
                                        u > 0 ? Math.abs(u) / o + 2 : 1)
                                }
                    ...
                    v = function (s) {
                        ...
                        if (r.animatingTo === r.currentSlide && !m && !(u === null)) {
                            ...
                            if (r.canAdvance(l) && (Number(new Date) - a < 550 && Math.abs(f) > 50 ||
                                    Math.abs(f) > o / 2)) {
                    ...
                    f = function (s) {
                        if (r.animating) {
                            ...
                            i = h && c && r.animatingTo === r.last ? 0 : h && c ? r.limit - (r.itemW +
                                ...
                                c ? (r.last - r.currentSlide + r.cloneOffset) * o : (r.currentSlide +
                                    r.cloneOffset) * o;
                            e = l ? y : g;
                            n = l ? g : y;
                        ...
                        if (!m || Number(new Date) - a > 500) {
                            ...
                            if (!p && n.transitions) {
                                if (!n.vars.animationLoop) {
                                    u = b / (n.currentSlide === 0 && b < 0 || n.currentSlide === n.last &&
                                        b > 0 ? Math.abs(b) / o + 2 : 1)
                                }
                    ...
                    function S(t) {
                        ...
                        if (r.animatingTo === r.currentSlide && !m && !(u === null)) {
                            ...
                            if (r.canAdvance(f) && (Number(new Date) - a < 550 && Math.abs(s) > 50 ||
                                    Math.abs(s) > o / 2)) {
                    ...
                    if (v.pauseInvisible.visProp) {
                        ...
                        document.addEventListener(n, function () {
                            if (v.pauseInvisible.isHidden()) {
                                ...
                                if (r.started) r.play();
                                else r.vars.initDelay > 0 ? setTimeout(r.play, r.vars.initDelay) :
                                    r.play()
                            }
                        })
                    }
        ...
        r.flexAnimate = function (t, n, s, u, a) {
            ...
            if (!r.animating && (r.canAdvance(t, a) || s) && r.is(":visible")) {
                ...
                if (!p) {
                    ...
                    } else if (r.currentSlide === 0 && t === r.count - 1 && r.vars.animationLoop && r.direction !==
                        "next") {
                        y = c ? (r.count + r.cloneOffset) * m : 0
                    } else if (r.currentSlide === r.last && t === 0 && r.vars.animationLoop && r.direction !==
                        "prev") {
                        y = c ? 0 : (r.count + 1) * m
                    } else {
        ...
        r.canAdvance = function (e, t) {
            ...
            return t ? true : d && r.currentItem === r.count - 1 && e === 0 && r.direction === "prev" ?
                true : d && r.currentItem === 0 && e === r.pagingCount - 1 && r.direction !== "next" ?
                false : e === r.currentSlide && !d ? false : r.vars.animationLoop ? true : r.atEnd && r.currentSlide ===
                0 && e === n && r.direction !== "next" ? false : r.atEnd && r.currentSlide === n && e ===
                0 && r.direction === "next" ? false : true
        };
        ...
        r.setProps = function (e, t, n) {
            var i = function () {
                var n = e ? e : (r.itemW + r.vars.itemMargin) * r.move * r.animatingTo,
                    i = function () {
                        if (h) {
                            return t === "setTouch" ? e : c && r.animatingTo === r.last ? 0 : c ? r.limit -
