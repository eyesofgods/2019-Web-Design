!
  ...
  httpsgithub.comkswedbergjquery-smooth-scroll
  Copyright (c) 2013 Karl Swedberg
  Licensed MIT (httpsgithub.comkswedbergjquery-smooth-scrollblobmasterLICENSE-MIT)
...
! function (l) {
    ...
    l.fn.extend({
        ...
        var o, r, n, s, c = 0,
            ...
            f = {},
            h = {};
        number == typeof t  (o = l.fn.smoothScroll.defaults, n = t)  (o = l.extend({}, l.fn.smoothScroll.defaults,
                t  {}), o.scrollElement && (i = position, static == o.scrollElement.css(position) && o.scrollElement
                .css(position, relative))), o = l.extend({
                link null
            }, o), a = left == o.direction  scrollLeft  a, o.scrollElement  (r = o.scrollElement, c = r[a]()) 
            r = l(html, body).firstScrollable(), o.beforeScroll.call(r, o), n = number == typeof t  t  e  l(
                o.scrollTarget)[i]() && l(o.scrollTarget)[i]()[o.direction]  0, f[a] = n + c + o.offset, s = o.speed,
            auto === s && (s = f[a]  r.scrollTop(), s = o.autoCoefficent), h = {
                duration s,
                easing o.easing,
                complete function () {
        ...
        return l.replace(^, ).replace((indexdefault).[a-zA-Z]{3,4}$, ).replace($, )
